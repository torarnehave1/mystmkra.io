...
/**
 * *@file services/greenbot/menus/editMenu.js
 * @module editMenu
 * @param {object} bot - The Telegram bot instance.
 * @param {number} chatId - The chat ID.
 *  
 * @returns {Promise<void>} - A Promise that resolves when the edit menu is sent.
 * 
 * @description This function sends the edit menu to the user, allowing them to select a process to edit.
 * If the user selects a process, they can choose to edit the process header, steps, or reorder the steps.
 * 
 */
